...
command = f'start cmd /k "docker run -it --name {args.hzport}-member --network hazelcast-network --rm -e HZ_NETWORK_PUBLICADDRESS=192.168.0.107:{args.hzport} -e HZ_CLUSTERNAME=ps_cluster -p {args.hzport}:5701 hazelcast/hazelcast:5.4.0"'
